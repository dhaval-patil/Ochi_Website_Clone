...
const Footer = () => {
  ...
  return (
    <div data-scroll data-scroll-speed=".7" className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
      <div className='w-1/2 h-full flex flex-col justify-between  font-["Founders Grotesk"]'>
        <div className="heading">
          ...
          <h1 className="text-[6vw] font-semibold uppercase -leading-1 -mb-10">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
      <h1 className="text-[6vw] h-full flex flex-col justify-between font-semibold uppercase leading-none -mb-10">
            Presentations
            <div className="dets font-[Neue_Montreal] mt-20 justify-center  flex gap-20">
